...
<form class="forecast-form" method="POST" action="<?= url("forecast") ?>">
    ...
    <input type="radio" name="forecast-period" value="0" checked> This week
    <input type="radio" name="forecast-period" value="1"> Past 30 days
    <br><br>
    <div class="error"><?= $msg ?></div>
    <input type="submit" name="submitBtn" value="Submit">
    <input type="submit" name="submitJsonBtn" value="Submit (JSON)">
</form>
